<template>
        <div class="app-homeContainer">
            ...
            <div class="white-bg p10 details_con">
                <h5 class="item-name" id="prodName">
                ...
                <ul>
                    ...
                    <li id="choose_0" index="0">
                        ...
                        <dl>
                            <dd><span  class="sp_black"></span>黑色</dd>
                            <dd><span  class="sp_red"></span>红色</dd>
                            <dd><span  class="sp_beige"></span>米色</dd>
                        </dl>
                    </li>
                    <br>
                    <li>
...
import  swiper from "../sub/swiper.vue";
     export default {
        ...
        getImage(){
        //发送ajax请求并且获取图片列表并显示
           var url="http://127.0.0.1:3000/img_splist"
...
<style>
 ...
 .app-homeContainer .mint-swipe img{
    ...
    #choose_0 dl dd .sp_black{
        border-left:30px solid #000;
    }
    #choose_0 dl dd .sp_red{
        border-left:30px solid red;
    }
     #choose_0 dl dd .sp_beige{
        border-left:30px solid #C7935A;
    }
      .img_width img{
        width:100%;
    }
